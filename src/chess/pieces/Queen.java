...
public class Queen implements Piece {
    ...
    /**
     * This method moves the current queen to newPosition, sets its current position to newPosition,
    ...
    /**
     * This method checks if this piece belongs to the current player, if the player wants to move the queen on the same
     * row/column or to a diagonal position, and also if between the queen's current position and the new one there are
     * no other pieces.
     ...
     *      it is moving on the same row/column or to a diagonal position,
     ...
     * It sets the current queen to the previous position, and if a piece that belongs to the opponent was removed,
     * it is put back on the board at its position.
     * @param oldPos - represents the position where the queen was before last move;
     * @param newPos - represents the current position for the queen and also the position for a piece that belongs to
